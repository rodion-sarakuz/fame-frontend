    ...
    <div>
        <b-container fluid="xl">
            <b-row style="margin: 36px 0 36px">
                <b-col cols="8"><h1 style="text-align: left">Акции</h1></b-col>
                <b-col cols="2"></b-col>
            ...
            <div style="overflow: hidden; border-radius: 6px; box-shadow: 0 0 40px rgba(0, 0, 0, 0.18);">
                <b-modal id="modal-xl" size="xl" title="Акция" hide-footer>
                        ...
                        <b-container class="bv-example-row">
                            <b-row>
                                <b-col class="content-edit" cols="10">
                                    ...
                                    <UploadImage set-collection="stock" :multiple="false" :current-image="edit.image" @uploadedImageUrl="applyUploadedImage"></UploadImage>
                                </b-col>
                ...
                <b-table-simple hover small caption-top responsive class="text-left">
                    ...
                    <b-tbody>
                        <b-tr v-for="(item, index) in items" :key="items.id" v-on:click="openModal(item)">
                            ...
                            <b-td>
                                <b-badge v-if="(new Date(item.date) > new Date(Date.now())) && item.status === 'published'" pill variant="success">Будет опубликованно</b-badge>
                                <b-badge v-else-if="item.status === 'published'" pill variant="success">Опубликовано</b-badge>
